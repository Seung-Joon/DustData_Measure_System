...
void DATA_TRANSMITTION(struct system_data sys, struct dust_data D_data) {
  ...
  // STARTING_BIT|SYSTEM_ID|PM1.0|PM2.5|PM10|Float_FLAG|SYSTEM_VOLTAGE|VOLTAGE_RESOLUTION|Float_FLAG|SOLAR_VOLTAGE|SOLAR_RESOLUTION|TEMPURATURE|HUMIDITY|ENDBIT
